	 ...
	 catchtouchmove="false">
		...
		<view class="cropper-crop-box" :class="{'pointer-events': cropFixed}" :style="{'width': cropW + 'px','height': cropH + 'px','transform': 'translate3d('+ cropOffsertX + 'px,' + cropOffsertY + 'px,' + '0)'}">
			...
			<block v-if="!cropFixed">
				...
				<view class="crop-area crop-area-lt"></view>
				<view class="crop-area crop-area-rt"></view>
				
				<view class="crop-area crop-area-lb"></view>
				<view class="crop-area crop-area-rb"></view>
			</block>
		</view>
		...
		<view class="uni-info__ft">
			<view class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0);" >
				<view class="imageBox">
					<image src="../../static/cancel.png" mode="aspectFit" @tap="cancel"></image>
				</view>
			</view>
			<view class="uni-modal__btn uni-modal__btn_primary" style="color: rgb(0, 122, 255);" >
				<view class="imageBox">
					<image src="../../static/identify.png" mode="aspectFit" @tap="confirm"></image>
				</view>
			</view>
		</view>
	</view>
...
<style scoped lang="css">
	...
	.crop-area.crop-area-lt{
		left :-2px;
		top:-2px;
		border-left:solid 3px #6aa3ce;
		border-top:solid 3px #6aa3ce;
	}
	.crop-area.crop-area-rt{
		right :-2px;
		top:-2px;
		border-right:solid 3px #6aa3ce;
		border-top:solid 3px #6aa3ce;
	}
	.crop-area.crop-area-lb{
		left :-2px;
		bottom:-2px;
		border-left:solid 3px #6aa3ce;
		border-bottom:solid 3px #6aa3ce;
	}
	.crop-area.crop-area-rb{
		right :-2px;
		bottom:-2px;
		border-right:solid 3px #6aa3ce;
		border-bottom:solid 3px #6aa3ce;
